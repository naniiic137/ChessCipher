...
Command-line tool that generates board images.
...
- **Free Board** — drag and drop pieces from the tray onto the board, see what message the occupied squares spell out in real-time
...
ChessCipher/
  ...
  index.html       # Interactive web app (self-contained)
